...
export declare class TunnelManagementHttpClient implements TunnelManagementClient {
     ...
     */
    constructor(userAgents: (ProductHeaderValue | string)[] | ProductHeaderValue | string, apiVersion: string, userTokenCallback?: () => Promise<string | null>, tunnelServiceUri?: string, httpsAgent?: https.Agent | undefined, adapter?: AxiosAdapter | undefined);
